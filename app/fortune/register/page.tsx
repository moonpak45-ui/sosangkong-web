...
// app/my-page/saju에서 이전됨 - buyer_profiles 유무와 무관하게 로그인만
// 되어 있으면(app/fortune/layout.tsx 가드) partner 계정도 접근 가능해야
// 해서 useMyPageLayout() 대신 세션을 직접 조회한다.
  ...
  return (
    <div style={styles.wrap}>
      <div style={styles.pageHead}>
        ...
        <p style={styles.headP}>생년월일을 등록하면 오늘의 사업운·매출운·거래운을 확인할 수 있어요.</p>
      </div>
      ...
      <div style={styles.card}>
        {saved && (
          <div style={styles.successBox}>
            저장됐어요.{' '}
            <a href="/fortune" style={styles.successLink}>
              오늘의 운세 보러가기 ›
            </a>
          </div>
        )}
